...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 h-24 pt-8 bg-white ">
      <div className="flex items-center justify-between h-full primary-container">
        ...
        <nav
          ...
          } fixed h-full sm:h-auto sm:static sm:block inset-x-0  bg-gray-400/50 top-24`}
        >
          <ul className="flex flex-col w-3/4 h-full gap-8 p-16 ml-auto bg-white first:text-sm sm:flex-row sm:w-full sm:p-0">
            <li>Home</li>
            <li>New</li>
            <li>Popular</li>
            <li>Trending</li>
